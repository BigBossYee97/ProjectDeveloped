...
public class PokestopVisited extends JFrame implements ActionListener{
   
    JLabel Header = new JLabel("Pokestop");
    JLabel FirstName = new JLabel("First Name:");
    JLabel LastName = new JLabel("Last Name:");
    JLabel TeamType = new JLabel("Team Type:");
    JLabel pokestopVisited = new JLabel("Pokestop Visited:");
    JLabel Date = new JLabel("Date:");
    JLabel Time = new JLabel("Time:");
    JLabel ItemReceived = new JLabel("Item Received:");
    JTextField FirstNameText = new JTextField(15);
    JTextField LastNameText = new JTextField(15);
    JComboBox TeamTypeText = new JComboBox();
    JTextField PokestopVisitedText = new JTextField(15);
    JTextField DateText = new JTextField(15);
    JTextField TimeText = new JTextField(15);
    JTextField ItemReceivedText = new JTextField(15);
...
PokestopVisited(){
        ...
        pokestopVisited.setFont(new Font("Arial Black", Font.PLAIN,12));
        Date.setFont(new Font("Arial Black", Font.PLAIN,12));
        Time.setFont(new Font("Arial Black", Font.PLAIN,12));
        ItemReceived.setFont(new Font("Arial Black", Font.PLAIN,12));
        ...
        pokestopVisited.setPreferredSize(new Dimension(120,40));
        Center3.add(pokestopVisited);
        Center3.add(PokestopVisitedText);
        ...
        Time.setPreferredSize(new Dimension(120,40));
        Center5.add(Time);
        Center5.add(TimeText);
        JPanel Center6 = new JPanel();
        Center6.setLayout(new FlowLayout(FlowLayout.CENTER));
        ItemReceived.setPreferredSize(new Dimension(120,40));
        Center6.add(ItemReceived);
        Center6.add(ItemReceivedText);
        ...
        Center7.add(TeamType);
        Center7.add(TeamTypeText);
        ...
        PokestopVisitedText.addActionListener(this);
        DateText.addActionListener(this);
        TimeText.addActionListener(this);
        ItemReceivedText.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if(e.getSource() == SaveButton){
            ...
            String TeamType = (String)TeamTypeText.getSelectedItem();
            String Pokestop = PokestopVisitedText.getText();
            String Date = DateText.getText();
            String Time = TimeText.getText();
            String ItemReceived = ItemReceivedText.getText();
            
            if(FirstName.equals("") || LastName.equals("") || TeamType.equals("") || Pokestop.equals("") || Date.equals("") || Time.equals("") || ItemReceived.equals("")){
                JOptionPane.showMessageDialog(null,"Please do not leave any blank empty.","Alert",JOptionPane.INFORMATION_MESSAGE);
            }
            else{
            boolean ok = db.PokestopVisited(FirstName,LastName,TeamType,Pokestop,Date,Time,ItemReceived);
            }
        }
    }
...
class DBHandler {
    ...
    public boolean PokestopVisited(String FirstName, String LastName, String TeamType, String Pokestop, String Date,String Time, String ItemReceived) {  // method to insert record into the table Video
        String array[] = {FirstName,LastName,TeamType,Pokestop,Date,Time,ItemReceived};
        String writeString =
            "INSERT INTO Pokestop(FirstName,LastName,TeamType,PokestopVisited,DateVisit,Time,Item) VALUES('"
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null,"Save Unsucess!","Alert",JOptionPane.INFORMATION_MESSAGE);
            return false; 
        }
        JOptionPane.showMessageDialog(null,"Pokestop Saved!","Alert",JOptionPane.INFORMATION_MESSAGE);
        return true; 
    }
