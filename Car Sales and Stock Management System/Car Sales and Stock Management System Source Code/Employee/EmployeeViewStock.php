...
if(isset($_POST["back"])){
header("location:EmployeeStockList.php");
...
<div style = "font-family:verdana;font-size:16px;float:left;margin-top:20px">
<label style = "margin-left:394px">Status: </label>
...
<button id = "back" style = "margin-top:10px;border:0px;width:100px;height:30px;margin-bottom:10px;background-color:#0eaded;color:white;border-radius:5px 5px" name = "back" >Back</button>
