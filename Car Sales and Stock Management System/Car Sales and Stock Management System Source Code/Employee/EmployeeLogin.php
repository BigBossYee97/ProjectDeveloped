...
<div id="wrapper" >
  ...
  <form method = "POST" action = "<?php $_SERVER['PHP_SELF'];?>" >
	...
	<p style = "font-family:verdana;font-size:12px;">Forgot Password?<a href = "EFP.php" style = "font-family:verdana;font-size:12px;color:red;text-decoration:none" >Reset</a></p>
	<p style = "font-family:verdana;font-size:12px;">Not An Employee?<a href = "CarSalesAdminLogin.php" style = "font-family:verdana;font-size:12px;color:red;text-decoration:none">Click Here</a></p>
