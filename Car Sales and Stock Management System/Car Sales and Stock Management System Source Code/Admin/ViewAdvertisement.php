...
if(isset($_POST["back"])){
	header("location:AdminAdvertisement.php");
...
<hr>
<textarea disabled name = "Description" style = "margin-bottom:20px;overflow-y:scroll;width:1040px;height:200px"><?php echo $description; ?></textarea>
<button style = "border:0px;width:100px;height:30px;margin-bottom:10px;background-color:#0eaded;color:white;border-radius:5px 5px" name = "back" >Back</button>
