        ...
        <div class="menu-list" class="collapsed active">
            ...
            <ul id="menu-content" class="menu-content collapse out">
			 <li>
                ...
                <li>
                  <a href="AdminAdvertisement.php">
                  <i class="fa fa-automobile"></i> Advertisements
                  </a>
                </li>

                <li  data-toggle="collapse" data-target="#products" >
                  <a href="#"><i class="fa fa-university"></i> Inventory <span class="arrow"></span></a>
                </li>
                <ul class="sub-menu collapse" id="products">
                    <li><a href="StockList.php">Stock List</li>
                    <li><a href="TradeList.php">Trade List</a></li>
                    <li><a href="ProfitandMargin.php">Profit of Year</a></li>
                    
                </ul>


                <li data-toggle="collapse" data-target="#service" class="collapsed">
                  <a href="#"><i class="fa fa-wrench"></i> Equipments <span class="arrow"></span></a>
                </li>  
                <ul class="sub-menu collapse" id="service">
                  <li id = "insurance">Insurance Renewal</li>
                  <li id = "loan">Loan Calculator</li>
                  <li id = "analysis">Business Analysis</li>
                </ul>


                <li data-toggle="collapse" data-target="#new" class="collapsed">
                  <a href="#"><i class="fa fa-users fa-lg"></i> Employee Profiles <span class="arrow"></span></a>
                </li>
				...
				while($row = mysqli_fetch_assoc($employeeResult)){
					...
					echo "<li><button name = 'employee' value = '$EmployeeID' style = 'color:#e1ffff;background-color:#181c20;border:none'>$EmployeeName</button></li>";
				}
				 }
				 ?>
				  <li id = "NewEmployee">New Employee</li>
                </ul>

				<li>
				<a href = "CompanyProfile.php">
				<i class = "fa fa-navicon"></i>Company Profile</a>
				</li>
				
                 

                 <li>
                  <a href="CarSalesAdminLogin.php">
...
loan.onclick = function(event){
	location.href = "LoanCalculator.php";
}

insurance.onclick = function(event){
	location.href = "InsuranceRenewal.php";
}

analysis.onclick = function(event){
	location.href = "BusinessAnalysis.php";
}

NewEmployee.onclick = function(event){
