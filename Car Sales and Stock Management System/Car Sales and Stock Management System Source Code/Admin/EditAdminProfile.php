...
if(mysqli_num_rows($result) > 0){
	...
	if(isset($_POST["save"])){
		...
		if($image !== ""){
		$update = "UPDATE admin SET Photo = '$image',Name = '$name',HP = '$hp',Email = '$email',Age = '$age' WHERE ID = $id";	
		...
		$update = "UPDATE admin SET Name = '$name',HP = '$hp',Email = '$email',Age = '$age' WHERE ID = $id";	
		if(mysqli_query($conn,$update)){
		$INFO = "Information Updated Successfully";
		header("location:AdminProfile.php");
		}
