...
<div align = "center"><br>
  ...
  <form method = "POST" action = "AdminProcessEmail.php" >	
   	<input type="email" name="email"  placeholder = "Email">
	<input type="submit" value="Submit">
	<br><a href = "CarSalesAdminLogin.php" style = "color:blue;font-size:14px;font-family:verdana">Back</a>
